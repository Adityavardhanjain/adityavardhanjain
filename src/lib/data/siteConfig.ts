...
export const ctaButtons = [
  { id: "explore", label: "Explore Missions", href: "#projects" },
  { id: "research", label: "Access Research Archive", href: "#research" },
  { id: "resume", label: "View Résumé", href: "#experience" },
  { id: "contact", label: "Establish Contact", href: "#contact" },
];
