  ...
  return (
    <section id="research" className="py-24 px-6">
      <div className="max-w-3xl mx-auto">
        <p className="text-sm text-[#64748b] mb-4">Research</p>
        ...
        {/* Research Interests */}
        <div className="mb-12">
          <h3 className="text-sm font-medium text-[#64748b] mb-4">Research Interests</h3>
        ...
        {/* Publications */}
        <div>
          <h3 className="text-sm font-medium text-[#64748b] mb-4">Publications</h3>
          <div className="space-y-4">
            {publications.map((pub) => (
              <div key={pub.id} className="p-5 bg-[#0f1923] border border-[rgba(255,255,255,0.08)] rounded-xl">
                ...
                <p className="text-sm text-[#64748b] mb-2">{pub.venue} · {pub.year}</p>
