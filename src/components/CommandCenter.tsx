    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-6">
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-sm text-[#64748b]">Available for opportunities</span>
        </div>
        ...
        <div className="flex justify-center gap-4">
          <a
            ...
            className="p-3 text-[#64748b] hover:text-[#60a5fa] bg-[rgba(96,165,250,0.05)] border border-[rgba(255,255,255,0.08)] rounded-lg hover:border-[rgba(96,165,250,0.3)] transition-all"
            aria-label="GitHub"
          >
