...
function ProjectVisual({ type, title }: { type: string; title: string }) {
  ...
  if (type === 'eeg') {
    visualContent = (
      <div className="project-visual__art">
        <span className="project-visual__wave project-visual__wave--one" />
        <span className="project-visual__wave project-visual__wave--two" />
        <span className="project-visual__node" />
      </div>
    );
  } else if (type === 'document') {
    visualContent = (
      <div className="project-visual__art">
        <span className="project-visual__document project-visual__document--back" />
        <span className="project-visual__document project-visual__document--front" />
        <span className="project-visual__cursor" />
      </div>
    );
  } else if (type === 'road') {
    visualContent = (
      <div className="project-visual__art">
        <span className="project-visual__road" />
        <span className="project-visual__marker project-visual__marker--one" />
        <span className="project-visual__marker project-visual__marker--two" />
      </div>
    );
  }
